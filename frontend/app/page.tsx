      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-8 lg:px-10">
        <section className="grid gap-10 pb-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="font-hero-syne mt-6 max-w-3xl text-5xl text-white sm:text-6xl">
            ...
            <GlassCard className="glass-panel mt-8 max-w-2xl p-4 sm:p-5">
              ...
              <div className="mt-4 flex flex-col gap-3">
                <div className="flex flex-wrap items-center gap-3">
                  <Link
                    href="/therapists"
                    className="button-secondary inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-medium"
                  >
                    Browse Therapists
                  </Link>
                  <Link
            ...
            <div id="therapists" className="section-anchor mt-10 grid gap-4 sm:grid-cols-3">
              <div className="glass-panel border rounded-[24px] px-4 py-4">
              ...
              <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
                <div className="liquid-glass-soft rounded-[24px] p-4">
                  <div className="mb-4 flex items-center justify-between gap-3">
                    ...
                    <Link
                      href="/therapists"
                      className="control-secondary px-3 py-1 text-xs"
                    >
                      View all
                    </Link>
                  </div>
                    ...
                    <div className="preview-scrollbar -mx-1 flex snap-x snap-mandatory gap-3 overflow-x-auto px-1 pb-5 pr-6">
                      {therapistPreviewCards.map((therapist) => (
                        ...
                        >
                          ...
                          <p className="mt-4 h-12 overflow-hidden text-sm leading-6 text-[var(--text-secondary)] line-clamp-2">
                            {therapist.bio}
                          </p>
                            ...
                            {therapist.languages.length > 0 ? (
                              therapist.languages.map((language) => (
                                <span
                                  ...
                                  className="glass-chip-muted inline-flex items-center justify-center px-3 py-1 text-xs leading-none text-[var(--chip-text-muted)]"
                                >
                                  {language}
                                </span>
                              ))
                            ) : (
                              <span className="glass-chip-muted inline-flex items-center justify-center px-3 py-1 text-xs leading-none text-[var(--chip-text-muted)]">
                                Language syncing
                              </span>
                            )}
                          </div>
